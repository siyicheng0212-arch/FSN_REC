...
parser.add_argument('--selection_metric', choices=['accuracy', 'macro_f1'], default='accuracy',
...
# ========================= FSN task-specific modules ==========================
parser.add_argument('--fsn_local_adapter', choices=['none', 'frame', 'temporal'], default='none',
                    help='none=official baseline; frame=kernel-1 control; temporal=kernel-3 adapter')
parser.add_argument('--fsn_adapter_dim', type=int, default=256)
parser.add_argument('--fsn_local_grid_size', type=int, default=3)
parser.add_argument('--fsn_interaction', choices=['none', 'mlp', 'cross_attention'], default='none',
                    help='mlp is the same-feature prediction-path control')
parser.add_argument('--fsn_interaction_dim', type=int, default=256)
parser.add_argument('--fsn_interaction_heads', type=int, default=4)
parser.add_argument('--fsn_interaction_dropout', type=float, default=0.1)
