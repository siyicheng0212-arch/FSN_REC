...
class AdaFocus(nn.Module):
    ...
    def forward(self, images_glance, images_input):
        ...
        if self.training:
            ...
            return global_avg_logit, global_final_logit + local_final_logit, global_avg_logit, local_avg_logit, temporal_sample_logits, spatial_sample_logits_3, action, action_3, weights, focus_indices
